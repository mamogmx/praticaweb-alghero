...
if (($modo=="edit") or ($modo=="new")){
		...
		if ($modo=="edit"){
			...
			$filetab="$tabpath/comm_edil_edit.tab";
			$filtro="id=$id";
		}
		else{
			$filetab="$tabpath/comm_edil_new.tab";
		...
		<table>
			<tr>
				<td><input name="active_form" type="hidden" value="pe.comm_paesaggio.php">
	...
	<?include "./inc/inc.window.php";
		...
		$numrec=$tabella->set_dati("pratica=$idpratica and ente in (78)");?>
		...
		<TABLE cellPadding=0  cellspacing=0 border=0 class="stiletabella" width="100%">
		  ...
		  <TR> 
			...
			<!-- tabella nuovo inserimento-->
				...
				<?print($tabella->elenco_stampe("pe.comm_paesaggio"));?>
