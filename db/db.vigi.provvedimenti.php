...
elseif ($_POST["azione"]=="Salva" and $_POST["tipo"]!=1){
	if ($_POST["mode"]=="new"){
		$id=$_SESSION["ADD_NEW"];
		$sql="UPDATE vigi.ordinanze SET tipo=".$_POST["tipo"]." WHERE pratica=$idpratica and id=$id";
		$db->sql_query($sql);
		//if (DEBUG) echo "$sql<br>";
	}
	$db->sql_query("DELETE FROM dest_provvedimenti WHERE pratica=$idpratica and id_provv=$id");
...
$active_form="vigi.provvedimenti.php?pratica=$idpratica";
?>