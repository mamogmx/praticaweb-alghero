<? 
	...
	if ($_POST["mode"]=="new") {
		...
		//print_r($_POST);
              ...
              $db->sql_query("update ce.commissione set pratica=$idpratica where id=$idpratica");
	...
	//if ($_POST["membro"]>0) $active_form="ce.commissione?pratica=$idpratica&mode=edit&head=no";
	//else
		$active_form="ce.commissione.php?pratica=$idpratica&mode=view";
